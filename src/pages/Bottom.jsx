...
<footer
  ...
  <h1 className='text-lg uppercase mb-10 font-semiboldbold font-[anzo2]'>Contact ME</h1>
    <div className="mb-6 flex justify-center space-x-2">
      <a
        href="https://www.facebook.com/meeranuzzaman.1/"
      ...
      <a onClick={() => {
    window.open(
      "https://mail.google.com/mail/?view=cm&fs=1&to=meeran.official1255@gmail.com&su=Let%27s%20Connect&body=Hi%20there!",
      "_blank"
    );
  }}
        href=""
      ...
      <a
        href="https://www.instagram.com/ig_meeran/"
        type="button" target='_blank'
      ...
      <a
        href="https://www.linkedin.com/in/meeran-uz-zaman-1946012b0/"
        type="button" target='_blank'
      ...
      <a
        href="https://github.com/meeran11"
        type="button" target='_blank'
  ...
  <div className="w-full bg-black/50 p-4 text-center">
    © 2025 Copyright: Meeran Uz Zaman
  </div>
</footer>
  )
}
